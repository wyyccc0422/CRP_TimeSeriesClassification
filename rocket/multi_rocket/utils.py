...
# Functions/Methods for core feature generation Taken from Original MultiRocket Without Changes
...
"""
float32[:]: The return of func `_fit_biases_` is a 1-dimensional array of 32-bit floating-point numbers.
(float64[:,:],int32[:],int32[:],float32[:]): the type of parameters of func `_fit_biases_`
"""
...
# Functions/Methods Taken from Original MultiROCKET Without Changes
